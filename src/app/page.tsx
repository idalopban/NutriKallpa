  ...
  return (
    <div className="min-h-screen min-h-screen-safe bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-green-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-950 flex flex-col mobile-safe">
      <div className="container mx-auto px-4 py-4 md:py-8 flex-1 flex flex-col overflow-y-auto">
                  ...
                  <div className="animate-in fade-in slide-in-from-left-4 duration-500">
                    ...
                    <CardContent>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className="text-xs text-[#ff8508] hover:underline focus:outline-none"
                            >
                      ...
                      <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
                        ¿Aún no tienes cuenta? <Link href="/register" className="font-semibold text-[#ff8508] hover:underline">Regístrate aquí</Link>
                      </div>
                    </CardContent>
                  </div>
                ) : (
                        ...
                        {recoveryStep === 'CODE' && (
                          <div className="space-y-2 animate-in fade-in slide-in-from-right-8">
                            ...
                            <p className="text-xs text-center text-gray-500 mt-2">
                              ¿No recibiste el código? <button type="button" onClick={() => setRecoveryStep('EMAIL')} className="text-[#ff8508] hover:underline">Reenviar</button>
                            </p>
                          </div>
                        )}
        ...
        {/* Footer */}
        <footer className="mt-auto pt-8 text-center text-sm text-gray-500 dark:text-gray-400 animate-in fade-in duration-1000 delay-500">
