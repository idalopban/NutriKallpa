...
import { User, Calendar, Activity, Scale, TrendingUp, Utensils } from 'lucide-react';
                                        ...
                                        <Table>
                                            <TableHeader>
                                                <TableRow className="bg-white border-b-slate-100">
                                                    <TableHead className="w-[40%] pl-6">Alimento</TableHead>
                                            ...
                                            <TableBody>
                                                {meal.items.map((item, i) => (
                                                    <TableRow key={i} className="border-b-slate-50 hover:bg-slate-50/50">
                                                        ...
                                                        <TableCell className="text-right py-3 bg-slate-50/30">{item.quantity}g</TableCell>
