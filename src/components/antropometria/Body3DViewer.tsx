...
export function Body3DViewer({ data, measurements, hoveredId, onLoaded }: Body3DViewerProps) {
    ...
    return (
        <div className="relative w-full h-full min-h-[500px] rounded-2xl overflow-hidden shadow-xl shadow-slate-300/50 dark:shadow-slate-900/50 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border border-slate-200/50 dark:border-slate-700/50">
