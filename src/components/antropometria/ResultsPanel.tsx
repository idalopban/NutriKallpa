    ...
    return (
        <div className="space-y-4 h-full">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-800 overflow-hidden">
                ...
                {hasBasicData && (
                    <div className="p-4">
                        <div className="p-3 bg-gradient-to-r from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-900/10 rounded-xl">
                            <div className="flex items-center justify-between">
                                <div className="text-xs text-blue-600 dark:text-blue-400 font-medium">IMC</div>
                                <div className="text-xl font-black text-blue-600 dark:text-blue-400">{imc.toFixed(1)}</div>
                            </div>
                        </div>
                    </div>
                )}
