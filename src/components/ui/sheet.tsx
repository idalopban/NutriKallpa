...
const sheetVariants = {
  ...
  left: "inset-y-0 left-0 h-full w-3/4 border-r rounded-r-lg max-w-sm",
  right: "inset-y-0 right-0 h-full w-3/4 border-l rounded-l-lg max-w-sm",
}
...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("mt-4 flex flex-row-reverse", className)} {...props} />
)
