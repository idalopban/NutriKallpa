...
export async function saveMedidasToSupabase(medidas: MedidasAntropometricas): Promise<boolean> {
    ...
    const dbData = {
        ...
        age: medidas.edad,
        triceps: medidas.pliegues?.triceps,
        subscapular: medidas.pliegues?.subscapular,
        biceps: medidas.pliegues?.biceps,
        iliac_crest: medidas.pliegues?.iliac_crest,
        supraspinale: medidas.pliegues?.supraspinale,
        abdominal: medidas.pliegues?.abdominal,
        thigh: medidas.pliegues?.thigh,
        calf: medidas.pliegues?.calf,
        arm_relaxed: medidas.perimetros?.brazoRelax,
        arm_flexed: medidas.perimetros?.brazoFlex,
        waist: medidas.perimetros?.cintura,
        hip: medidas.perimetros?.cadera,
        thigh_mid: medidas.perimetros?.musloMedio,
        calf_max: medidas.perimetros?.pantorrilla,
        humerus: medidas.diametros?.humero,
        femur: medidas.diametros?.femur,
    };
    ...
    if (error) {
        console.error('Error saving medidas to Supabase:', error);
        return false;
    }
